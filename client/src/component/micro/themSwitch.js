...
const ThemeSwitch = () => {
    ...
    return (
        <div>
            <div className="w-8 h-8 relative cursor-pointer overflow-hidden rounded-full m-5 bg-primary dark:bg-secondary hover:shadow-2xl" onClick={() => {setColorTheme(colorTheme)}}>
